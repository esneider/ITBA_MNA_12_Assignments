...
De la ecuación \eqref{matsa} se puede apreciar que si los autovalores de la matriz diagonal son 
...
Asumiendo el peor caso, cuando el coseno vale 1, y reemplazando por los valores de la ecuación \eqref{matsa} se deduce: 
...
Es fácil ver que si $\omega = 0$ la derivada es igual a cero. Sustituyendo $\omega$ por 0 en \eqref{vnvn}, se llega a:
\[
...
en los que \omega vale $-\pi$ y $\pi$. Es fácil ver de \eqref{vnvn} que si $\omega$ vale $\pi$ la inecuación 
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.4]{./img/r.png}
	\end{center}
\end{figure}
\begin{center}
...
\section*{Anexo A: Deducción ecuación en diferencias}
